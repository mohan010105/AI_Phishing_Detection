...
export const env = {
  ...
  // ---- Supabase ----
  SUPABASE_URL: optional("SUPABASE_URL") ?? optional("NEXT_PUBLIC_SUPABASE_URL"),
  SUPABASE_ANON_KEY: optional("SUPABASE_ANON_KEY") ?? optional("NEXT_PUBLIC_SUPABASE_ANON_KEY"),
